...
╠❂͜͡➣Kick ...
╠❂͜͡➣Invite (by mid)
╠❂͜͡➣Undang (Invite by kontak)
╠❂͜͡➣Tarik/Jepit (Invite by kontak)
╠❂͜͡➣Adminlist
╠❂͜͡➣Bot Add @
╠❂͜͡➣Spam... (spam on 10 tes)
╠❂͜͡➣Bot? (cek kontak bot)
╠❂͜͡➣Cancel (cncl undngn trtunda)
╠❂͜͡➣clean invites
╠❂͜͡➣clear invites
╠════════════
╠❂͜͡➣Message change:...
...
╠❂͜͡➣Buka qr/Open qr
╠❂͜͡➣link open
╠❂͜͡➣Tutup qr/Close qr
╠❂͜͡➣link close
╠❂͜͡➣Rejectall (reject semua invite)
╠❂͜͡➣Protect:hight/low
╠❂͜͡➣Auto blockqr:off/on
╠❂͜͡➣Namelock:on/off
╠❂͜͡➣Blockinvite:on/off
╠❂͜͡➣Joinn on/off (kick protect join)
╠❂͜͡➣Cancel on/off(cncl all undngan)
╠❂͜͡➣Qr on/off (protect qr)
╠❂͜͡➣Contact On/off
╠❂͜͡➣Join on/off (auto join bot)
╠❂͜͡➣Gcancel:on/off (invite grup)
╠❂͜͡➣Leave on/off
╠❂͜͡➣Share on/off
╠❂͜͡➣Add on/off
╠❂͜͡➣Cancelall (canccel all invite)
╠❂͜͡➣Comment off/on
╠❂͜͡➣Backup:on/off
╠❂͜͡➣Mode on
╠════════════
...
╠❂͜͡➣Bot restart
╠❂͜͡➣Turn off bots
╠❂͜͡➣Allbio: (ganti bio stat bot)
╠❂͜͡➣Myname: (ganti nama bot)
╠════════════
╠❂͜͡➣Banlist
╠❂͜͡➣Cek ban
╠❂͜͡➣Kill ban
...
creator=["uc8487830df0446e693d46f5642e25b7a"]
admin=["uc8487830df0446e693d46f5642e25b7a",mid,Amid,Bmid,Cmid,Dmid,Smid] #Krisna,kris,
...
creator: line.me/ti/p/~gaming.88""",
    "lang":"JP",
...
#============================================================
              ...
              if msg.from_ in admin:
                md = "⭐Status Proteksi⭐\n*============*\n"
                if wait["Protectgr"] == True: md+="❂͜͡➣Protect QR [On]\n"
                ...
                if wait["qr"] == True: md+="❂͜͡➣AutoBlock QR : on\n"
                else:md+="❂͜͡➣AutoBlock QR : off\n"
                if wait["commentOn"] == True: md+="❂͜͡➣Comment [On]\n"
                else:md+="❂͜͡➣Comment [Off]\n"
                if wait["Protectcancel"] == True: md+="❂͜͡➣Protect Cancel [On]\n"
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Kr asup","Aw"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Kabur all","Uih"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
          ...
          try:
            if op.param1 in wait2['readPoint']:
              ...
              if Name in wait2['readMember'][op.param1]:
                ...
                wait2['readMember'][op.param1] += "\n❂͜͡➣" + Name
                wait2['ROM'][op.param1][op.param2] = "❂͜͡➣" + Name
            else:
              cl.sendText
          except:
             pass
